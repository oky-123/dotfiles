...
register_indent("javascriptreact", "setlocal sw=2 sts=2 ts=2 et")
register_indent("typescript",      "setlocal sw=2 sts=2 ts=2 et")
register_indent("typescriptreact", "setlocal sw=2 sts=2 ts=2 et")
...
register_indent("sql",             "setlocal sw=2 sts=2 ts=2 et")
