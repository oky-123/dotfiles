...
export declare namespace MetalsTreeViewChildren {
    const type: RequestType<MetalsTreeViewChildrenParams, MetalsTreeViewChildrenResult, void, void>;
}
export interface MetalsTreeViewDidChangeParams {
    nodes: MetalsTreeViewNode[];
}
export declare namespace MetalsTreeViewDidChange {
    const type: NotificationType<MetalsTreeViewDidChangeParams, void>;
}
...
export declare namespace MetalsTreeViewParent {
    const type: RequestType<MetalsTreeViewParentParams, MetalsTreeViewParentResult, void, void>;
}
...
export declare namespace MetalsTreeViewVisibilityDidChange {
    const type: NotificationType<MetalsTreeViewVisibilityDidChangeParams, void>;
}
...
export declare namespace MetalsTreeViewNodeCollapseDidChange {
    const type: NotificationType<MetalsTreeViewNodeCollapseDidChangeParams, void>;
}
...
export declare namespace MetalsTreeViewReveal {
    const type: RequestType<TextDocumentPositionParams, MetalsTreeRevealResult, void, void>;
}
