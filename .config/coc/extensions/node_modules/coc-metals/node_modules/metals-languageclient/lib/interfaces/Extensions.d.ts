import { NotificationType, ExecuteCommandParams } from "vscode-languageserver-protocol";
/**
...
export declare namespace ExecuteClientCommand {
    const type: NotificationType<ExecuteCommandParams, void>;
}
/**
 ...
 */
export declare namespace MetalsDidFocus {
    const type: NotificationType<string, void>;
}
/**
 ...
 */
export declare namespace MetalsWindowStateDidChange {
    const type: NotificationType<MetalsWindowStateDidChangeParams, void>;
}
