 ...
 */
export declare namespace MetalsInputBox {
    const type: RequestType<InputBoxOptions, MetalsInputBoxResult, void, void>;
    const handleInput: (result: string | undefined) => MetalsInputBoxResult;
}
...
export interface InputBoxOptions {
    ...
    value?: string;
    /** * Selection of the prefilled [`value`](#InputBoxOptions.value). Defined as tuple of two number where the * first is the inclusive start index and the second the exclusive end index. When `undefined` the whole * word will be selected, when empty (start equals end) only the cursor will be set, * otherwise the defined range will be selected.  */ valueSelection?: [number, number];
    /**
...
//# sourceMappingURL=MetalsInputBox.d.ts.map